...
export const ordenesTrabajo: OrdenTrabajo[] = [
  ...
  ot(4, { status: 'Asignada', prioridad: 'Alta', tipo_trabajo: 'Electrico', ...activo(2), tecnico_id: 2, asignador_id: 1, fecha_asignada: '2026-07-18', detalle: 'Cortocircuito en tablero.' }),
  ot(5, { status: 'Asignada', prioridad: 'Media', tipo_trabajo: 'Ventilacion', ...activo(7), tecnico_id: 8, asignador_id: 1, fecha_asignada: '2026-07-19' }),
  ot(6, { status: 'Asignada', prioridad: 'Baja', tipo_trabajo: 'Chequeo', ...activo(9), tecnico_id: 10, asignador_id: 3, fecha_asignada: '2026-07-20' }),
