...
function ot(id: number, overrides: Partial<OrdenTrabajo>): OrdenTrabajo {
  const base: OrdenTrabajo = {
    ...
    tipo_tarea: 'Chequeo',
    tipo_prioridad: 'Vacante', // "Requiere parada de equipo" = ocupación de la unidad
    unidad_id: null,
    torre: null,
    departamento: null,
    concat_activo: null,
...
export const ordenesTrabajo: OrdenTrabajo[] = [
  ...
  ot(4, { status: 'Asignada', prioridad: 'Alta', tipo_prioridad: 'Ocupada', tipo_trabajo: 'Electrico', ...activo(2), tecnico_id: 2, asignador_id: 1, fecha_asignada: '2026-07-18', detalle: 'Cortocircuito en tablero.' }),
  ot(5, { status: 'Asignada', prioridad: 'Media', tipo_prioridad: 'Vacante con ingreso', tipo_trabajo: 'Ventilacion', ...activo(7), tecnico_id: 8, asignador_id: 1, fecha_asignada: '2026-07-19' }),
  ot(6, { status: 'Asignada', prioridad: 'Baja', tipo_prioridad: 'Bloqueada', tipo_trabajo: 'Chequeo', ...activo(9), tecnico_id: 10, asignador_id: 3, fecha_asignada: '2026-07-20' }),
...
export const salidasStock: SalidaStock[] = [
  { id: 1, articulo_id: 1, stock_id: stockIdFor(1), edificio_destino_id: null, concat_articulo: concatArt(1), tecnico_id: 2, tipo: 'ASIGNACION', fecha_salida: '2026-07-18', fecha_reingreso: null, uso: 'Consumo Diario', centro_de_costo: 'Palermo Soho', cantidad: 3, usuario_id: 2, fecha: '2026-07-18T10:15:00Z', version_app: 'v20260622_1.3.2' },
  { id: 2, articulo_id: 7, stock_id: stockIdFor(7), edificio_destino_id: null, concat_articulo: concatArt(7), tecnico_id: 8, tipo: 'CONSUMIBLE', fecha_salida: '2026-07-10', fecha_reingreso: null, uso: 'Consumo Diario', centro_de_costo: 'Nuñez', cantidad: 2, usuario_id: 8, fecha: '2026-07-10T11:00:00Z', version_app: 'v20260622_1.3.2' },
